...
def main():
    ...
    if use_existing_collections == 'y':
        ...
        UPPER_BOUND = input('Enter the upper bound for number of PDFs to crawl (around 1.3 minutes for 100 pdfs) or "" for no limit: ')
        if UPPER_BOUND == '':
            UPPER_BOUND = None
        else:
    ...
    for num_clusters in [2, 10, 20]:
        ...
        visualize_clusters(MY_COLLECTION_WEIGHT_MATRIX, num_clusters=num_clusters, cmap=cmap)
